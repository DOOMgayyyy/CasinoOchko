...
class Deck {
    /**
     * @var array $cards Массив карт в колоде
     */
    private $cards = [];
    
    /**
     * @var array $suits Массив всех мастей в колоде
     */
    private $suits = [
        'hearts',    # Черви
        'diamonds',  # Бубны
    ...
    /**
     * @var array $ranks Массив всех рангов карт в колоде
     */
    private $ranks = [
        'A',   # Туз
        '2',   # Двойка
    ...
    private function createDeck() {
        ...
        # Создаем карты для каждой масти
        foreach ($this->suits as $suit) {
            # Создаем карты каждого ранга для текущей масти
     ...
     * 
     * Использует встроенную функцию PHP shuffle() для
